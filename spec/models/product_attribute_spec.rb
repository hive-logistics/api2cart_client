...
# Unit tests for SwaggerClient::ProductAttribute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductAttribute' do
  before do
    # run before each test
    @instance = SwaggerClient::ProductAttribute.new
  end
  ...
  describe 'test an instance of ProductAttribute' do
    it 'should create an instance of ProductAttribute' do
      expect(@instance).to be_instance_of(SwaggerClient::ProductAttribute)
    end
  end
