...
module SwaggerClient
  class ProductVariantAdd
    ...
    def self.swagger_types
      {
        ...
        :'barcode' => :'String',
        :'price' => :'Float',
        :'attributes' => :'Array<ProductVariantAddAttributes>',
        :'description' => :'String',
        :'special_price' => :'Float',
    ...
    def hash
      [product_id, name, model, barcode, price, attributes, description, special_price, sprice_create, sprice_modified, sprice_expire, available_for_view, available_for_sale, weight, weight_unit, short_description, warehouse_id, quantity, created_at, manufacturer, tax_class_id, meta_title, meta_keywords, meta_description, url, store_id, lang_id, clear_cache, taxable].hash
    end
