...
module SwaggerClient
  class ProductReview
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nick_name')
    ...
    def hash
      [id, product_id, customer_id, nick_name, email, summary, message, rating, ratings, status, created_time, additional_fields, custom_fields].hash
    end
