...
module SwaggerClient
  class Brand
    ...
    def hash
      [id, name, created_time, modified_time, full_description, short_description, stores_ids, active, url, meta_title, meta_keywords, meta_description, additional_fields, custom_fields].hash
    end
