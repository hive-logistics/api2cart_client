...
module SwaggerClient
  class OrderAdd
    ...
    def self.swagger_types
      {
        ...
        :'note_attributes' => :'Array<OrderAddNoteAttributes>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'admin_private_comment')
      ...
      if attributes.has_key?(:'note_attributes')
    ...
    def hash
      [order_id, store_id, channel_id, order_status, send_notifications, send_admin_notifications, customer_email, bill_first_name, bill_last_name, bill_address_1, bill_city, bill_postcode, bill_state, bill_country, shipp_first_name, shipp_last_name, shipp_address_1, shipp_city, shipp_postcode, shipp_state, shipp_country, total_price, date, order_payment_method, order_shipping_method, currency, bill_address_2, bill_company, bill_phone, bill_fax, comment, admin_comment, admin_private_comment, customer_first_name, customer_last_name, customer_birthday, customer_fax, customer_phone, shipp_address_2, shipp_company, shipp_phone, shipp_fax, date_modified, date_finished, subtotal_price, tax_price, shipping_price, shipping_tax, discount, coupon_discount, gift_certificate_discount, fulfillment_status, financial_status, total_paid, external_source, tags, inventory_behaviour, create_invoice, note_attributes, order_item].hash
    end
