...
module SwaggerClient
  class OrderShipmentAdd
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enable_cache')
        self.enable_cache = attributes[:'enable_cache']
      else
        self.enable_cache = false
      end

      if attributes.has_key?(:'tracking_link')
    ...
    def hash
      [order_id, store_id, warehouse_id, shipment_provider, items, send_notifications, tracking_numbers, adjust_stock, enable_cache, tracking_link].hash
    end
