...
module SwaggerClient
  class CouponAction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'include_tax')
      ...
      if attributes.has_key?(:'discounted_quantity')
        self.discounted_quantity = attributes[:'discounted_quantity']
      end

      if attributes.has_key?(:'discount_quantity_step')
        self.discount_quantity_step = attributes[:'discount_quantity_step']
      end

      if attributes.has_key?(:'logic_operator')
