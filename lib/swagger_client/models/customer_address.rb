...
module SwaggerClient
  class CustomerAddress
    ...
    def hash
      [id, type, first_name, last_name, postcode, address1, address2, phone, city, country, state, company, fax, website, gender, region, default, additional_fields, custom_fields].hash
    end
