...
module SwaggerClient
  class AccountApi
    ...
    # @option opts [String] :amazon_access_token MWS Auth Token. Access token authorizing the app to access resources on behalf of a user
    # @option opts [String] :amazon_seller_id Amazon Seller ID
    # @option opts [String] :amazon_marketplaces_ids Amazon Marketplace IDs comma separated string
