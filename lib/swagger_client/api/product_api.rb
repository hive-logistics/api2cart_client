...
module SwaggerClient
  class ProductApi
    ...
    # @option opts [Float] :old_price Defines product&#39;s old price
    ...
    # @option opts [String] :backorder_status Set backorder status
    ...
    # @option opts [BOOLEAN] :taxable Specifies whether a tax is charged (default to true)
    # @return [InlineResponse20027]
    ...
    # @option opts [BOOLEAN] :clear_cache Is cache clear required
    # @option opts [String] :gtin Global Trade Item Number. An GTIN is an identifier for trade items.
    # @option opts [BOOLEAN] :taxable Specifies whether a tax is charged
    # @return [Array<(InlineResponse20027, Fixnum, Hash)>] InlineResponse20027 data, response status code and response headers
    def product_update_with_http_info(id, opts = {})
      ...
      query_params[:'old_price'] = opts[:'old_price'] if !opts[:'old_price'].nil?
      query_params[:'price'] = opts[:'price'] if !opts[:'price'].nil?
      ...
      query_params[:'backorder_status'] = opts[:'backorder_status'] if !opts[:'backorder_status'].nil?
      query_params[:'name'] = opts[:'name'] if !opts[:'name'].nil?
      query_params[:'sku'] = opts[:'sku'] if !opts[:'sku'].nil?
      ...
      query_params[:'taxable'] = opts[:'taxable'] if !opts[:'taxable'].nil?
