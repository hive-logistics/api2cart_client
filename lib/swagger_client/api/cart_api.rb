...
module SwaggerClient
  class CartApi
    ...
    # @option opts [String] :params Set this parameter in order to choose which entity fields you want to retrieve
    # @option opts [String] :exclude Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all
    # @return [Array<(ModelResponseCartMetaDataList, Fixnum, Hash)>] ModelResponseCartMetaDataList data, response status code and response headers
    def cart_meta_data_list_with_http_info(entity_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ModelResponseCartMetaDataList')
      if @api_client.config.debugging
    ...
    def cart_meta_data_set(entity_id, key, value, opts = {})
      data, _status_code, _headers = cart_meta_data_set_with_http_info(entity_id, key, value, opts)
      data
    end
    ...
    def cart_meta_data_set_with_http_info(entity_id, key, value, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :store_id Store Id
    # @return [InlineResponse20019]
    def cart_meta_data_unset(entity_id, key, opts = {})
      data, _status_code, _headers = cart_meta_data_unset_with_http_info(entity_id, key, opts)
      data
    end
    ...
    # @option opts [String] :store_id Store Id
    # @return [Array<(InlineResponse20019, Fixnum, Hash)>] InlineResponse20019 data, response status code and response headers
    def cart_meta_data_unset_with_http_info(entity_id, key, opts = {})
      if @api_client.config.debugging
